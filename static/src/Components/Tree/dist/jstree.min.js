        ...
        !c &&
            ...
            (E.jstree.core.prototype = {
                                    ...
                                    if (
                                        (t.slice(e).each(
                                            function (e, t) {
                                                if (
                                                    0 ===
                                                    E(t).text().toLowerCase().indexOf(s)
                                                )
                                                    return (
                                                        E(t).trigger('focus'), !(r = !0)
                                                    );
                                            }.bind(this)
                                        ),
                                        r)
                ...
                load_node: function (n, d) {
                    ...
                    if (n.state.loaded) {
                        for (
                            n.state.loaded = !1, r = 0, s = n.parents.length;
                            r < s;
                            r++
                        )
                            this._model.data[n.parents[r]].children_d =
                                E.vakata.array_filter(
                                    this._model.data[n.parents[r]].children_d,
                                    function (e) {
                        ...
                        for (t = 0, i = n.children_d.length; t < i; t++)
                            this._model.data[n.children_d[t]].state.selected &&
                                (a = !0),
                ...
                _load_nodes: function (e, t, i, r) {
                    for (
                        ...
                        n[e[d]] &&
                            ((!n[e[d]].state.loaded && !n[e[d]].state.failed) ||
                                (!i && r)) &&
                            (this.is_loading(e[d]) || this.load_node(e[d], a),
                            (s = !1));
                    if (s) {
                ...
                _append_html_data: function (e, t, i) {
                    ...
                    for (
                        t.each(
                            function (e, t) {
                                (o = this._parse_model_from_html(
                                    ...
                                    (s.push(o),
                                    a.push(o),
                                    n[o].children_d.length &&
                                        (a = a.concat(n[o].children_d)));
                            }.bind(this)
                        ),
                            d.children = s,
                            d.children_d = a,
                        ...
                        n[d.parents[c]].children_d =
                            n[d.parents[c]].children_d.concat(a);
                                    ...
                                    p = function (e, t, i) {
                                        ...
                                        for (
                                            ...
                                            (n = p(u[o.children[s]], o.id, i)),
                                                ...
                                                o.children_d.push(n),
                                                d.children_d.length &&
                                                    (o.children_d = o.children_d.concat(
                                                        d.children_d
                                                    ));
                                        return (
                                            delete e.data,
                            ...
                            n = function (e, t) {
                                if (null !== this.element) {
                                    ...
                                    if (((this._model.data = e.mod), t)) {
                                        ...
                                        if (
                                            n.length !== d.length ||
                                            E.vakata.array_unique(n.concat(d))
                                                .length !== n.length
                                        ) {
                                    ...
                                    e.add.length &&
                                        (this._data.core.selected =
                                            this._data.core.selected.concat(e.add)),
                                        this.trigger('model', {
                                            nodes: e.dpc,
                                            parent: e.par,
                                        }),
                ...
                _parse_model_from_html: function (e, t, i) {
                    ...
                    (t = e.children('a').children('.jstree-themeicon')).length &&
                        (n.icon =
                            !t.hasClass('jstree-themeicon-hidden') && t.attr('rel')),
                        n.state.icon !== P && (n.icon = n.state.icon),
                        (n.icon !== P && null !== n.icon && '' !== n.icon) ||
                            (n.icon = !0),
                            ...
                            ? (t.each(
                                  function (e, t) {
                                      (r = this._parse_model_from_html(E(t), n.id, i)),
                                          ...
                                          n.children.push(r),
                                          s.children_d.length &&
                                              (n.children_d = n.children_d.concat(
                                                  s.children_d
                                              ));
                                  }.bind(this)
                              ),
                ...
                _parse_model_from_flat_json: function (e, t, i) {
                    ...
                    if (e && 'object' == typeof e.li_attr)
                        for (n in e.li_attr)
                            e.li_attr.hasOwnProperty(n) &&
                                (l.li_attr[n] = e.li_attr[n]);
                    if (
                ...
                _parse_model_from_json: function (e, t, i) {
                    ...
                    return (
                        ...
                        delete e.children,
                        (l.original = e),
                        (o[l.id] = l).state.selected &&
                            this._data.core.selected.push(l.id),
                        l.id
                    );
                },
                _redraw: function () {
                ...
                redraw_node: function (e, t, i, r) {
                    ...
                    if (
                        ...
                        (e = E(e)),
                            i ||
                                ((a = e.parent().parent()[0]) === this.element[0] &&
                                    (a = null),
                                (n = e.index())),
                            (t =
                                !t &&
                    ...
                    if (
                        ...
                        g[s.parent] &&
                        !s.state.hidden &&
                        ((o = E.inArray(s.id, g[s.parent].children)),
                        (k = s.id),
                        -1 !== o)
                    )
                            ...
                            (!1 === s.icon
                                ...
                                : ((e.childNodes[1].childNodes[0].style.backgroundImage =
                                  ...
                                  (e.childNodes[1].childNodes[0].style.backgroundPosition =
                                      'center center'),
                                  (e.childNodes[1].childNodes[0].style.backgroundSize =
                                      'auto'),
                                  (e.childNodes[1].childNodes[0].className +=
                    ...
                    if ((d && e.appendChild(d), !i)) {
                        for (
                            ...
                            if (
                                ...
                                -1 !==
                                    a.childNodes[o].className.indexOf('jstree-children')
                            ) {
                                p = a.childNodes[o];
                                break;
                            }
                        ...
                        this.is_closed(e)
                            ? this.is_loaded(e)
                                ? ((a = this.get_node(e, !0)),
                                  ...
                                  (r && a.length) ||
                                      this.trigger('after_open', { node: e }),
                                  !0)
                                : this.is_loading(e)
                                ? setTimeout(
                                      function () {
                    ...
                    if (
                        ...
                        if (t.shiftKey) {
                            for (
                                ...
                                s[n] === i && (a = !a),
                                    s[n] === r && (a = !a),
                                    this.is_disabled(s[n]) ||
                                    (!a && s[n] !== i && s[n] !== r)
                                        ? t.ctrlKey || this.deselect_node(s[n], !0, t)
                                        : this.is_hidden(s[n]) ||
                                          this.select_node(s[n], !0, !1, t);
                            this.trigger('changed', {
                                action: 'select_node',
                ...
                set_id: function (e, t) {
                    ...
                    for (
                        t = t.toString(),
                            s[e.parent].children[
                                E.inArray(e.id, s[e.parent].children)
                            ] = t,
                            i = 0,
                            r = e.parents.length;
                        i < r;
                ...
                get_text: function (e) {
                    return (
                        !(!(e = this.get_node(e)) || e.id === E.jstree.root) && e.text
                    );
                },
                ...
                move_node: function (e, t, i, r, s, a, n) {
                    ...
                    if (
                        ...
                        (g =
                            !(_ =
                                n ||
                                (this._model.data[e.id]
                                    ? this
                                    : E.jstree.reference(e.id))) ||
                            !_._id ||
                            this._id !== _._id),
                        (l =
                            _ &&
                    ...
                    if (e.parent === h.id) {
                        ...
                        for (
                            ...
                            for (
                                u = [],
                                    v = 0,
                                    j = (k = _._model.data[e.parents[p]].children_d)
                                        .length;
                                v < j;
                                v++
                            )
                        ...
                        for (
                            ...
                            (this._model.data[e.children_d[p]].parents =
                                this._model.data[e.children_d[p]].parents.slice(
                                    0,
                                    -1 * k
                                )),
                        ...
                        (this.check('edit', r, this.get_parent(r))
                            ? ((l = r),
                              ...
                              (c = E('<input />', {
                                  ...
                                  keyup: function (e) {
                                      c.width(
                                          Math.min(o.text('pW' + this.value).width(), i)
                                      );
                                  },
                                  keypress: function (e) {
                              ...
                              c
                                  .css(t)
                                  .width(
                                      Math.min(o.text('pW' + c[0].value).width(), i)
                                  )[0]
                                  .select(),
                              void E(b).one(
                        ...
                        !1 === t
                            ...
                            : (!0 === t || null === t || t === P || '' === t
                                  ...
                                  ? (s.removeClass(a).css('background', ''),
                                    s
                                        .addClass(t + ' jstree-themeicon-custom')
                                        .attr('rel', t))
                                  : (s.removeClass(a).css('background', ''),
                                    s
                ...
                get_icon: function (e) {
                    return (
                        !(!(e = this.get_node(e)) || e.id === E.jstree.root) && e.icon
                    );
                },
            ...
            (E.jstree.plugins.checkbox = function (e, o) {
                (this.bind = function () {
                            ...
                            this.element
                                ...
                                .on(
                                    ...
                                    function (e, t) {
                                        var i = this,
                                            ...
                                            h = {},
                                            _ =
                                                this._data[l ? 'core' : 'checkbox']
                                                    .selected;
                                        for (n = 0, d = _.length; n < d; n++)
                                            h[_[n]] = !0;
                                        if (-1 !== t.indexOf('down'))
                                            for (
                                                var g = this._cascade_new_checked_state(
                                                        r.id,
                                                        !0
                                                    ),
                                        ...
                                        if (-1 !== t.indexOf('up'))
                                            while (a && a.id !== E.jstree.root) {
                                                for (
                                                    n = o = 0, d = a.children.length;
                                                    n < d;
                                                    n++
                                                )
                                                    o +=
                                                        s[a.children[n]].state[
                                                            l ? 'selected' : 'checked'
                                                        ];
                                                if (o !== d) break;
                                ...
                                .on(
                                    ...
                                    function (e, t) {
                                        ...
                                        if (
                                            (-1 !== o.indexOf('down') &&
                                                ((g = this._cascade_new_checked_state(
                                                    r.id,
                                                    !1
                                                )),
                                                (t = E.vakata.array_filter(
                                                    t,
                                                    function (e) {
                                                        return (
                                                            -1 === _.indexOf(e) ||
                                ...
                                .on(
                                    ...
                                    function (e, t) {
                                        ...
                                        while (
                                            ...
                                            for (
                                                s = n = 0, a = i.children.length;
                                                s < a;
                                                s++
                                            )
                                                n +=
                                                    r[i.children[s]].state[
                                                        o ? 'selected' : 'checked'
                                                    ];
                                            if (!(0 < a && n === a)) break;
                                    ...
                                    function (e, t) {
                                        ...
                                        if (!i) {
                                            ...
                                            while (
                                                ...
                                                for (
                                                    d = n = 0, o = a.children.length;
                                                    d < o;
                                                    d++
                                                )
                                                    n +=
                                                        s[a.children[d]].state[
                                                            l ? 'selected' : 'checked'
                                                        ];
                                                if (!(0 < o && n === o)) break;
                                                (a.state[l ? 'selected' : 'checked'] =
                    ...
                    (this.get_undetermined = function (e) {
                        if (
                            -1 ===
                            this.settings.checkbox.cascade.indexOf('undetermined')
                        )
                            return [];
                        for (
                            var i,
                            ...
                            this.element
                                ...
                                .each(function () {
                                    ...
                                    if (e)
                                        if (e.state.loaded) {
                                            for (
                                                i = 0, r = e.children_d.length;
                                                i < r;
                                                i++
                                            )
                                                if (
                                                    !(t = d[e.children_d[i]]).state
                                                        .loaded &&
                                                    t.original &&
                                                    t.original.state &&
                        ...
                        if ((e = o.redraw_node.apply(this, arguments))) {
                            for (
                                ...
                                if (
                                    ...
                                    -1 !==
                                        e.childNodes[s].className.indexOf(
                                            'jstree-anchor'
                                        )
                                ) {
                                    n = e.childNodes[s];
                    ...
                    (this.disable_checkbox = function (e) {
                        ...
                        if (!(e = this.get_node(e)) || e.id === E.jstree.root)
                            return !1;
                        (r = this.get_node(e, !0)),
                    ...
                    (this.delete_node = function (e) {
                        ...
                        if (!(e = this.get_node(e)) || e.id === E.jstree.root)
                            return !1;
                        for (
                            (t = e.children_d.concat([])).push(e.id),
                                i = 0,
                                r = t.length;
                            i < r;
                            i++
                                ...
                                !e && t && n.length === s.children.length
                                    ? ((s.state[r ? 'selected' : 'checked'] = t),
                                      ...
                                      h
                                          ...
                                          .attr('aria-selected', !0)
                                          .addClass(
                                              r ? 'jstree-clicked' : 'jstree-checked'
                                          ))
            ...
            ((h = E).vakata.context = {
                ...
                show: function (e, t, i) {
                    var r,
                        ...
                        l = !0;
                    switch (
                        (g.element && g.element.length && g.element.width(''), !0)
                    ) {
                        case !t && !e:
                            return !1;
                        case !!t && !!e:
                    ...
                    g.element
                        ...
                        .on('keydown', function (e) {
                            ...
                            var e = g.element
                                ...
                                .parent();
                            e.parent().not('.vakata-context-disabled') &&
                                e.trigger('click');
                        }),
                    h(b)
                        ...
                        d.bind.call(this),
                            this.element.on(
                                ...
                                function (e) {
                                    if (
                                        this.settings.dnd.large_drag_target &&
                                        E(e.target).closest('.jstree-node')[0] !==
                                            e.currentTarget
                                    )
                                        return !0;
                                    if (
            ...
            E(function () {
                ...
                E(b)
                    ...
                    .on('dnd_start.vakata.jstree', function (e, t) {
                        (O = N = !1),
                            t && t.data && t.data.jstree && S.appendTo(b.body);
                    })
                    .on('dnd_move.vakata.jstree', function (e, s) {
                        ...
                        if (
                            ...
                            s &&
                                ...
                                s.data.jstree &&
                                (!s.event.target.id ||
                                    'jstree-marker' !== s.event.target.id))
                        ) {
                            O = s.event;
                                            ...
                                            if (
                                                ...
                                                return (
                                                    ...
                                                    s.event.originalEvent &&
                                                        s.event.originalEvent
                                                            .dataTransfer &&
                                                        (s.event.originalEvent.dataTransfer.dropEffect =
                                                            x ? 'copy' : 'move'),
                                                    (T = {}),
                                                    !(u = !0)
                                                );
            ...
            (f.vakata.dnd = {
                ...
                _scroll: function (e) {
                    if (!p.scroll_e || (!p.scroll_l && !p.scroll_t))
                        return (
                            p.scroll_i &&
                                (clearInterval(p.scroll_i), (p.scroll_i = !1)),
                            !1
                        );
                    if (!p.scroll_i)
                        return (
                            (p.scroll_i = setInterval(f.vakata.dnd._scroll, 100)), !1
                        );
                    if (!0 === e) return !1;
                ...
                start: function (e, t, i) {
                    ...
                    return (
                        ...
                        !1 !== i &&
                            (p.helper = f("<div id='vakata-dnd'></div>")
                                .html(i)
                                .css({
                                    display: 'block',
                                    margin: '0',
                    ...
                    if (
                        ('touchmove' === i.type &&
                            ...
                            (i.target = b.elementFromPoint(
                                i.originalEvent.changedTouches[0].pageX -
                                    window.pageXOffset,
                                i.originalEvent.changedTouches[0].pageY -
                                    window.pageYOffset
                            ))),
                        p.is_down)
                    ) {
                        ...
                        return (
                            ...
                            p.helper &&
                                ((c = parseInt(
                                    i.pageY + f.vakata.dnd.settings.helper_top,
                                    10
                                )),
                                (l = parseInt(
                                    i.pageX + f.vakata.dnd.settings.helper_left,
                                    10
                                )),
                        ...
                        if (
                            ...
                            E.each(o[i || E.jstree.root].children_d, function (e, t) {
                                ...
                                i.text &&
                                    ...
                                    ((n.search_callback &&
                                        n.search_callback.call(this, r, i)) ||
                                        (!n.search_callback &&
                                            c.search(i.text).isMatch)) &&
                                    (l.push(t), (h = h.concat(i.parents)));
                            }),
                            l.length)
                        ) {
                            for (
                                _ = 0, g = (h = E.vakata.array_unique(h)).length;
                                _ < g;
                                _++
                            )
                                h[_] !== E.jstree.root &&
                ...
                (this.init = function (e, t) {
                            ...
                            for (r = 0, s = d.length; r < s; r++)
                                (d[r].type =
                                    ...
                                    t &&
                                        ...
                                        d[r].li_attr &&
                                            d[r].li_attr.id &&
                                            delete d[r].li_attr.id,
                                        d[r].a_attr &&
                                            d[r].a_attr.id &&
                                            delete d[r].a_attr.id);
                        else
                            (d.type =
                                ...
                                if (
                                    ...
                                    if (
                                        ...
                                        return !(this._data.core.last_error = {
                                            ...
                                            id: 'types_01',
                                            reason:
                                                'max_children prevents function: ' + e,
                                            data: JSON.stringify({
                                                chk: e,
                                                pos: r,
                                                obj:
                                    ...
                                    if (a && t.children_d && t.parents) {
                                        for (
                                            o = d = 0, c = t.children_d.length;
                                            o < c;
                                            o++
                                        )
                                            d = Math.max(
                                                d,
                                                a[t.children_d[o]].parents.length
                                            );
                    ...
                    (this.set_type = function (e, t) {
                        ...
                        if (
                            ...
                            (!0 !== d &&
                                r[n] &&
                                (r[n].icon === P || d !== r[n].icon)) ||
                                this.set_icon(e, r[t].icon === P || r[t].icon),
                            r[n] &&
                                r[n].li_attr !== P &&
                                'object' == typeof r[n].li_attr)
                        )
